    ...
    return (
      <div className="container">
        ...
        <div style={{ marginTop: "4rem" }} className="row">
          <div
            className="col s8 offset-s2 login-page"
            style={{ marginTop: "50px" }}
          >
            <Link to="/" className="btn-flat waves-effect">
              <i className="material-icons left">keyboard_backspace</i>
              {this.state.landingPageData
                ? this.state.landingPageData.Login.backHome
                : "loading"}
            </Link>
            <div className="col s12" style={{ paddingLeft: "11.250px" }}>
              <h4>
                {this.state.landingPageData
                  ? this.state.landingPageData.Login.loginBelow
                  : "loading"}
              </h4>
              <p className="grey-text text-darken-1">
                {this.state.landingPageData
                  ? this.state.landingPageData.Login.noAccount
                  : "loading"}{" "}
                <Link to="/register">
                  {this.state.landingPageData
                    ? this.state.landingPageData.Login.toRegister
                    : "loading"}
                </Link>
              </p>
            </div>
            <form noValidate onSubmit={this.onSubmit}>
              <div className="input-field col s12">
                ...
                <label htmlFor="email">
                  {this.state.landingPageData
                    ? this.state.landingPageData.Login.email
                    : "loading"}
                </label>
              ...
              <div className="input-field col s12">
                ...
                <label htmlFor="password">
                  {this.state.landingPageData
                    ? this.state.landingPageData.Login.password
                    : "loading"}
                </label>
                <span className="red-text">
                  {errors.password}
              ...
              <div className="col s12" style={{ paddingLeft: "11.250px" }}>
                ...
                >
                  {this.state.landingPageData
                    ? this.state.landingPageData.Login.button
                    : "loading"}
                </button>
              </div>
            </form>
            ...
            {/* <form noValidate onSubmit={this.onSubmit} autoComplete="off">
              <FormControl>
                <InputLabel htmlFor="email">{this.state.landingPageData ? this.state.landingPageData.Login.email: "loading"}</InputLabel>
                <Input
                  onChange={this.onChange}
                  value={this.state.email}
                  error={errors.email}
