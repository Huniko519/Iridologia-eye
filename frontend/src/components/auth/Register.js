...
class Register extends Component {
  ...
  render() {
    ...
    const termsCheckboxLabel = (
      <div>
        {this.state.landingPageData ? this.state.landingPageData.Register.accept : "loading"}<Link to="/privacy-policy">{this.state.landingPageData ? this.state.landingPageData.Register.privacyLink : "loading"}</Link>
      </div>
    );
    ...
    return (
      <div className="container">
        ...
        <div className="row">
          <div className="col s8 offset-s2 register-page" style={{ marginTop: "100px" }}>
